    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a href="tel:5555555555" className={`font-bold hidden lg:flex items-center gap-2 transition-colors ${isScrolled ? 'text-slate-900' : 'text-white'} hover:text-red-600`}>
      ...
      <div className={`fixed inset-0 bg-white z-40 transition-transform duration-500 md:hidden ${
        ...
        <div className="flex flex-col items-center justify-center h-full gap-8 p-4">
          ...
          <a href="tel:5555555555" className="text-xl font-bold text-slate-900 flex items-center gap-3">
